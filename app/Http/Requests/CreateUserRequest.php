...
class CreateUserRequest extends FormRequest
{
    ...
    public function messages()
    {
        return[
            ...
            'email.unique' => 'Adresa de email exista deja inregistrata pe acest site',
            ...
            'role.required' => 'Trebuie sa atribuiti utilizatorului un rol',
            'password.require' => 'Trebuie sa introduceti o parola a utilizatorului',
            'password.min' => 'Parola trebuie sa aiba cel putin 8 caractere',
            'password.confirmed' => 'Parola nu este corecta',
            'photo.max' => 'Fotografia utilizatorului nu poate avea mai mult de 1Mb!'
        ];
    }
}
